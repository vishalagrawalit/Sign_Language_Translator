...
def hog_compute(ims):
    ...
    padding = (8, 8)
    locations = (
    (10, 20), (30, 30), (50, 50), (70, 70), (90, 90), (110, 110), (130, 130), (150, 150), (170, 170), (190, 190))
    for im in ims:
...
def load_img_labels(num, num2, folder):
    ...
    for i in range(65, 81):
        for j in range(1, 401):
            print('loading ' + folder + '/' + chr(i) + '_' + str(j) + '.jpg')
            imgs.append(cv2.imread(folder + '/' + chr(i) + '_' + str(j) + '.jpg', 0))
    labels = np.repeat(np.arange(1, 17), 400)
    return imgs, labels
